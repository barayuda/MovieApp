...
import barayuda.com.finalproject.Adapter.GridViewAdapter;
import barayuda.com.finalproject.Entity.Favorite;
...
public class MovieItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, fetchMovies.getStatus().toString());
    ...
    public void onBackPressed() {
        ...
        else Toast.makeText(getBaseContext(), R.string.exit_title, Toast.LENGTH_SHORT).show();
    ...
    private class FetchMovies extends AsyncTask<String, Void, List<Movie>> {
        ...
        protected List<Movie> doInBackground(String... params) {
            ...
            try {
                ...
                final String API_KEY = "?api_key=709ea1e158ff0075a9d5a7fcb6bbd53c";
    ...
    private class FetchMoviesFavorite extends AsyncTask<String, Void, List<Movie>> {
        private final String LOG_TAG = FetchMovies.class.getSimpleName();
